...
def NOTIFIED_ACCEPT_GROUP_INVITATION(op):
    try:
        sendMessage(op.param1, client.getContact(op.param2).displayName + "Selamat Datang Di " + group.name + "Jangan Nakal Ya Kak ")
    except Exception as e:
        print e
...
def NOTIFIED_KICKOUT_FROM_GROUP(op):
    try:
        sendMessage(op.param1, client.getContact(op.param3).displayName + " Sayonara\n Jangan Balik Lagi")
    except Exception as e:
        print e
...
def NOTIFIED_LEAVE_GROUP(op):
    try:
        sendMessage(op.param1, client.getContact(op.param2).displayName + " Sayonara\n Jangan Balik Lagi")
    except Exception as e:
        print e
